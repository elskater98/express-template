module.exports ={
    ...
    devel_database: process.env.DATABASE || 'mongodb://db:password@localhost:27017/devel',
    prod_database: process.env.DATABASE || 'mongodb://db:password@localhost:27017/prod',
